...
PREPARATION_METHODS = [
    {
        ...
        'prep_class': {
            'klass': 'openn.prep.medren_prep.MedrenPrep',
            'config': {
                'host': 'dla.library.upenn.edu',
                'path': '/dla/medren/pageturn.xml?id=MEDREN_{0}',
                'xsl': os.path.join(SITE_ROOT, 'xsl/pih2tei.xsl'),
    ...
    },
    {
        ...
        'prep_class': {
            'klass': 'openn.prep.spreadsheet_prep.SpreadsheetPrep',
            'kwargs': {
                'config_json': os.path.join(SITE_ROOT, 'pacscl_diaries.json'),
            },
            'config' : {
...
COLLECTIONS = {
    ...
    'configs': [
        ...
        {
            'tag': 'ulpx',
            'name': 'Union League of Philadelphiax',
            'metadata_type': 'TEI',
            'live': False,
            'blurb': 'Documents from the Union League of Philadelphia.',
            'include_file': 'UnionLeagueOfPhiladelphiax.html',
        },
