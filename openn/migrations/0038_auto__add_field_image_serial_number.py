...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Image.serial_number'
        db.add_column(u'openn_image', 'serial_number',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.serial_number'
        db.delete_column(u'openn_image', 'serial_number')
    ...
    models = {
        ...
        u'openn.document': {
            ...
            'base_dir': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100'}),
        ...
        u'openn.image': {
            ...
            'serial_number': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'openn.prepstatus': {
