...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'openn_document', 'base_dir', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Document.base_dir'
        db.alter_column(u'openn_document', 'base_dir', self.gf('django.db.models.fields.CharField')(max_length=30))
