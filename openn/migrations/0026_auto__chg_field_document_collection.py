...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Document.collection'
        db.alter_column(u'openn_document', 'collection', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Document.collection'
        raise RuntimeError("Cannot reverse this migration. 'Document.collection' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.collection'
        db.alter_column(u'openn_document', 'collection', self.gf('django.db.models.fields.CharField')(max_length=30))
