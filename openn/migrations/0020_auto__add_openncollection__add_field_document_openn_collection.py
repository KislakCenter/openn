...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OPennCollection'
        db.create_table(u'openn_openncollection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=50)),
        ))
        db.send_create_signal(u'openn', ['OPennCollection'])

        # Adding field 'Document.openn_collection'
        db.add_column(u'openn_document', 'openn_collection',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['openn.OPennCollection'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OPennCollection'
        db.delete_table(u'openn_openncollection')

        # Deleting field 'Document.openn_collection'
        db.delete_column(u'openn_document', 'openn_collection_id')
