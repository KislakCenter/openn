...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TemplateHash'
        db.create_table(u'openn_templatehash', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sha256', self.gf('django.db.models.fields.CharField')(default=None, max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal(u'openn', ['TemplateHash'])

        # Adding model 'TemplateFile'
        db.create_table(u'openn_templatefile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=255)),
        ))
        db.send_create_signal(u'openn', ['TemplateFile'])

        # Adding model 'SiteFile'
        db.create_table(u'openn_sitefile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('output_file', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=255)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='html_pages', null=True, blank=True, to=orm['openn.TemplateFile'])),
            ('template_hash', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='html_pages', null=True, blank=True, to=orm['openn.TemplateHash'])),
            ('last_generated', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True)),
            ('include_file', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='include_pages', null=True, blank=True, to=orm['openn.TemplateFile'])),
            ('include_file_hash', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='include_pages', null=True, blank=True, to=orm['openn.TemplateHash'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'openn', ['SiteFile'])


    def backwards(self, orm):
        # Deleting model 'TemplateHash'
        db.delete_table(u'openn_templatehash')

        # Deleting model 'TemplateFile'
        db.delete_table(u'openn_templatefile')

        # Deleting model 'SiteFile'
        db.delete_table(u'openn_sitefile')
    ...
    models = {
        ...
        u'openn.sitefile': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'include_file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'include_pages'", 'null': 'True', 'blank': 'True', 'to': u"orm['openn.TemplateFile']"}),
            'include_file_hash': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'include_pages'", 'null': 'True', 'blank': 'True', 'to': u"orm['openn.TemplateHash']"}),
            'last_generated': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'output_file': ('django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '255'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'html_pages'", 'null': 'True', 'blank': 'True', 'to': u"orm['openn.TemplateFile']"}),
            'template_hash': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'html_pages'", 'null': 'True', 'blank': 'True', 'to': u"orm['openn.TemplateHash']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'openn.templatefile': {
            'Meta': {'object_name': 'TemplateFile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': 'None', 'unique': 'True', 'max_length': '255'})
        },
        u'openn.templatehash': {
            'Meta': {'object_name': 'TemplateHash'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sha256': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        u'openn.version': {
