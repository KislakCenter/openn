...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OPennCollection.metadata_type'
        db.add_column(u'openn_openncollection', 'metadata_type',
                      self.gf('django.db.models.fields.CharField')(default='tei', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OPennCollection.metadata_type'
        db.delete_column(u'openn_openncollection', 'metadata_type')
