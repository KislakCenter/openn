...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Image.image_type'
        db.alter_column(u'openn_image', 'image_type', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Image.image_type'
        db.alter_column(u'openn_image', 'image_type', self.gf('django.db.models.fields.CharField')(max_length=1))
