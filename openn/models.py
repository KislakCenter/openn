...
class Document(models.Model):
    ...
    base_dir                  = models.CharField(max_length = 100, null = False, default = None, blank = False)
    image_licence             = models.CharField(max_length = 20, null = True, default = 'PD', blank = True)
    metadata_licence          = models.CharField(max_length = 20, null = True, default = 'CC-BY', blank = True)
